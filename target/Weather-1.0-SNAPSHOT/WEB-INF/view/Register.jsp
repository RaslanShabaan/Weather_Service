        ...
        <div class="login" class="clearfix">
            ...
            <form method="post" action="" id="form-control" >
                ...
                <div class="control-group">
                    <input  type="text"  name="loginName" id="email"  placeholder="User Name ">
                </div>
                <div class="control-group">
                    <input  type="text"  name="loginName" id="password" placeholder="User E-Mail">
                </div>
                <div class="control-group">
                    <input  type="text"  name="loginName" id="vpassword" placeholder="User PassWord">
                </div>


                <div class="form-actions">
                    <button class="btn" type="submit" >Register Me Up</button>
