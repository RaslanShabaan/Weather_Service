        ...
        <div class="login" class="clearfix">
            ...
            <form method="post" action="" id="form-control" >
                ...
                <div class="control-group">
                    <input  type="text"  name="loginName" id="email"  placeholder="User ID">
                </div>
                <div class="control-group" >
                    <input  type="text"  name="loginName" id="password" placeholder="User Password">
                </div>

                <div class="form-actions">
                    <button class="btn" type="submit" >Sign Up</button>
                    <button class="btn" type="button" >Regiser</button>
                </div>
            </form>
        </div>
