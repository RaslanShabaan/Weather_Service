...
<h1 style="margin: auto;color: #fff;font-style: italic;font-weight: bold">
    Welcome :)
                ...
                <div class="menu-wrapper">
                    <ul class="menu">
                        ...
                        <form action="/Logout" method="get">
                            <button style="width: 100%;height:50px;font-weight: bold;font-style: italic;border: none;background-color: #fff">LogOut</button>
                        </form>
                        </li>
