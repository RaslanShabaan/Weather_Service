        ...
        <div class="login" class="clearfix">
            ...
            <form method="post" name="Spring_Form" action="/Register" id="form-control" onsubmit="return Security()">
                <div class="control-round" id="control-round">
                    <label for="Spring_Name" class="active">1</label>
                    <label for="Spring_Email">2</label>
                    <label for="Spring_Password">3</label>
                </div>
                <div class="control-group">
                    <input  type="text"  name="UName" id="Spring_Name"  placeholder="User Name ">
                </div>
                <div class="control-group">
                    <input  type="email"  name="UEmail" id="Spring_Email" placeholder="User E-Mail">
                </div>
                <div class="control-group">
                    <input  type="password"  name="UPass" id="Spring_Password" placeholder="User PassWord">
                </div>
...
<script>
   function Security(){
           ...
           var text=/^[A-Za-z]+$/;
           // UserName Validation //
           if (document.Spring_Form.Spring_Name.value.length <1) {
               alert("User Name Is Requred.");
               return false;
           }
           if(document.Spring_Form.Spring_Name.value.length >20) {
               alert("User Name Is InValid Too Long .");
               return false;
           }

           if( document.Spring_Form.Spring_Name.value.match(text)) {
           ...
           if (document.Spring_Form.Spring_Password.value.length < 1) {
               alert("User PassWord Is Requred .");
               return false;
           }

           //  email  Validation //
           if (document.Spring_Form.Spring_Email.value.length < 1) {
